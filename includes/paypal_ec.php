...
class paypal_ec
{
    ...
    */
    function set_ec($ec_data = array(), $custom_data = false)
    {
        ...
        if ($custom_data === false)
        {
            ...
            {
                $nvpstr .= ($ec_data['get_shipping'] === true) ? "&NOSHIPPING=2" :
                    "&NOSHIPPING=1";
            }
            else
            {
            ...
            $nvpstr .= "&PAYMENTREQUEST_0_AMT=" . urlencode(sprintf('%.2f', $total_amount +
                $shipping_amount + $tax_amount + $handling_amount));
        }
        else
        {
    ...
    * --------------------------------------------------------------------------------
    */
    function do_ec($ec_details = array(
        'token' => '',
        'payer_id' => '',
        'currency' => '',
        'amount' => '',
    ...
    */
    ...
    {
        $payPalURL = ($mobile === true) ? str_replace("_express-checkout",
            "_express-checkout-mobile", $this->paypal_url) : $this->paypal_url;
